...
const JobApply = ({jobId }: JobApplyProps["jobid"]) => {
    const params = useParams();
    const jobid = params.id;
    const { authToken, singleJob, userdata } = myAppHook();
    ...
    const handleJobApply = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            formData.append('jobid', jobApplyData.jobid);
            formData.append('name', jobApplyData.name);
            formData.append('email', jobApplyData.email);
            formData.append('phone', jobApplyData.phone);
            formData.append('cover_letter', jobApplyData.cover_letter);
            formData.append('resume', jobApplyData.resume);
