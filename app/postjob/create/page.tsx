...
const PostJobEdit = () => {
    ...
    const { isLoading, authToken, categories, createjob } = myAppHook();
    ...
    const handleFormSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        e.preventDefault();
        console.log(postjob);
        const response = await createjob(postjob);
    }
                            ...
                            <div className="row">
                                <form onSubmit={handleFormSubmit}>
                                    ...
                                    <div className="col-12 col-md-6">
                                        ...
                                        defaultValue={postjob.job_category_id} onChange={handleInputChange} required>
